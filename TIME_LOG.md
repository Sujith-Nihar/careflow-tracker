...
| 3 | 2026-09-19 | Phase 0 tooling and Phase 1 domain layer (types, derivation, statement rules, tests, schema) | 1.5 | 55 tests, 100% derivation coverage; schema not yet applied |

**Total so far: 5.0 h** (budget remaining: 11.0 h)
