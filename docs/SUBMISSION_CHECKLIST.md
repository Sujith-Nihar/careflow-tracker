...
| 2 | End-to-end trace: scenario → dial → functions → DB → evaluator → UI | `SUBMISSION.md §2` linking `artifacts/v2/<run>/C_*/` and a UI screenshot | ☐ |
| 3 | Initial plan + practice-manager update | `docs/PROJECT_PLAN.md §1`, `docs/MANAGER_UPDATE.md` | ☐ |
| 4 | Time log ≤ 16 h | `TIME_LOG.md` | ☐ |
...
| 8 | Flow export, agent/version and dial IDs, replay | `vogent/export/`, `SUBMISSION.md §8`, `make replay` | ☐ |
| 9 | Security, privacy, reliability, production risks | `docs/RISKS.md` | ☐ |
